...
#   ./deployment/run_client_lego.sh --dry-run    # Test without robot commands
#   ./deployment/run_client_lego.sh --mock       # Test without robot hardware
#   ./deployment/run_client_lego.sh --test-only  # Test server connection only
#
